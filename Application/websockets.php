...
abstract class WebSocketServer {
  ...
  abstract protected function process(User $user, string $message); // Called immediately when the data is recieved.
  abstract protected function connected(User $user);        // Called after the handshake response is sent to the client.
  abstract protected function closed(User $user);           // Called after the connection is closed.
